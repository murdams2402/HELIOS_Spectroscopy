...
model_configs = (
    ...
    ([0x1016], 'HR2000+', 4097, end_points['EP1_OUT'], end_points['EP1_IN'], 64, end_points['EP2_IN'], 512),
    ([0x1012], 'HR4000', 3648, end_points['EP1_OUT'], end_points['EP1_IN'], 64, end_points['EP2_IN'], 512),
